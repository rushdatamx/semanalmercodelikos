...
const months = [
  { mes: "Enero", v26: 1.79, v25: 1.01, var: "+77.1%", pos: true },
  { mes: "Febrero", v26: 1.92, v25: 1.22, var: "+57.9%", pos: true },
  { mes: "Marzo", v26: 2.54, v25: 1.56, var: "+62.9%", pos: true },
  { mes: "Abril", v26: 2.02, v25: 1.40, var: "+44.0%", pos: true },
];
    ...
    <SlideWrapper className="bg-[#F5F5F5] p-10">
      ...
      <div className="flex items-center gap-8 mb-5">
        ...
        <div className="flex items-center gap-2 bg-[#27AE60]/10 border border-[#27AE60]/20 rounded-xl px-5 py-3 animate-count-up" style={{ animationDelay: "150ms" }}>
          ...
          <div>
            <p className="text-[#27AE60] text-2xl font-bold">+59.4%</p>
            <p className="text-gray-500 text-[10px]">vs Ene-Abr 2025 ($5.2M)</p>
          </div>
        </div>
      ...
      <div className="mt-3 bg-[#27AE60]/5 border border-[#27AE60]/20 rounded-xl px-5 py-2">
        <p className="text-[#27AE60] text-[11px] font-semibold">
          &#9989; Los 4 meses crecen — el mejor primer cuatrimestre en la historia de la cuenta. 39 de 40 tiendas crecen vs 2025.
        </p>
      </div>
    </SlideWrapper>
  );
