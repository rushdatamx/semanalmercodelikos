...
/* ── Monthly sales Roja 70PZ (15 periods) ── */
const rojaMensual = [
...
const bullets = [
  ...
  {
    icon: BarChart3,
    text: "69.1% de Abarrotes",
    sub: "$4.33M de $6.27M del departamento en Q1",
  },
];
...
export default function CrecAbaSlide4Tostada() {
  return (
    <SlideWrapper className="bg-[#F5F5F5] p-5">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-800">
              Tostada Roja 70PZ: Motor de Abarrotes
            </h2>
            <p className="text-[10px] text-gray-500">
              El producto estrella que impulsa el departamento
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-2.5 mb-3">
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-3 text-center">
          ...
          <p className="text-2xl font-bold text-red-500">$4.33M</p>
                ...
                <Line
                  ...
                  dot={(props) => {
                    const { cx, cy, payload, index } = props as {
                      cx: number;
                      cy: number;
                      payload: { mes: string; venta: number };
                      index: number;
                    };
                    const isRecord =
