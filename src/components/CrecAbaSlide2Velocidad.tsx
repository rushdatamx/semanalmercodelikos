...
/* ── Monthly velocity (uds/day) — Abarrotes only, 15 periods ── */
const velocityData = [
  { mes: "2025-01", vel: 735 },
  { mes: "2025-02", vel: 996 },
  { mes: "2025-03", vel: 1234 },
  { mes: "2025-04", vel: 1147 },
  { mes: "2025-05", vel: 1357 },
  { mes: "2025-06", vel: 1094 },
  { mes: "2025-07", vel: 1124 },
  { mes: "2025-08", vel: 1995 },
  { mes: "2025-09", vel: 1683 },
  { mes: "2025-10", vel: 2102 },
  { mes: "2025-11", vel: 2216 },
  { mes: "2025-12", vel: 2457 },
  { mes: "2026-01", vel: 1924 },
  { mes: "2026-02", vel: 2308 },
  { mes: "2026-03", vel: 2609 },
];

/* ── Velocity by sub-category (Q1 2026, uds/day) ── */
const categories = [
  {
...
export default function CrecAbaSlide2Velocidad() {
  return (
      ...
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-800">
              Velocidad de Venta — Abarrotes
            </h2>
            <p className="text-[10px] text-gray-500">
              Unidades vendidas por dia — 20 SKUs Abarrotes — 15 periodos
            </p>
          </div>
        </div>
        {/* Hero metric */}
        <div className="flex items-center gap-4">
          <div className="text-right">
            ...
            <p className="text-lg font-bold text-gray-400">988</p>
          ...
          <div className="text-right bg-emerald-50 rounded-lg px-3 py-1.5 border border-emerald-200">
            ...
            <p className="text-2xl font-bold text-emerald-700">2,279</p>
      ...
      <div className="flex gap-3 flex-1 min-h-0">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          <p className="text-[10px] text-gray-500 font-semibold uppercase mb-1">
            Tendencia de velocidad por periodo (Abarrotes, uds/dia)
          </p>
        ...
        {/* Right panel: velocity by sub-category */}
        <div className="w-[280px] flex flex-col">
          <p className="text-[10px] text-gray-500 font-semibold uppercase mb-1">
            Velocidad por sub-categoria (Q1 2026)
          </p>
          ...
          <div className="bg-emerald-50 rounded-lg p-2.5 border border-emerald-200 mt-2">
            <p className="text-[10px] text-emerald-700 font-bold">
              Velocidad mas que duplicada (+131%)
            </p>
            <p className="text-[9px] text-emerald-600 mt-0.5">
              De 988 a 2,279 uds/dia. Tostada Roja 70PZ representa el 51% de
              la velocidad total de Abarrotes.
            </p>
          </div>
        </div>
      </div>
