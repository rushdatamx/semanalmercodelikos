...
export default function FyvSlide1Portada() {
  return (
    <SlideWrapper className="bg-[#F5F5F5] justify-center items-center text-center relative" hideFooter>
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden">
        <div className="absolute -top-40 -right-40 w-[500px] h-[500px] rounded-full bg-[#27AE60]/15 blur-3xl" />
      ...
      <div className="relative z-10 space-y-6">
        ...
        <h1 className="text-5xl font-bold text-gray-800 tracking-tight">
          Reporte Semanal — Frutas y Verduras
        </h1>
        <div className="flex items-center justify-center gap-3">
          <img src="/merco-logo.jpg" alt="MERCO" className="h-16 object-contain" />
        </div>
        <p className="text-xl text-gray-500">Semana del 10 de marzo 2026</p>
