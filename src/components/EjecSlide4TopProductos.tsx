...
const pieData: PieProduct[] = [
  ...
  { nombre: "Papa Casera 45g (3 SKUs)", venta: 411185, pct: 5.8, color: "#3B82F6" },
  { nombre: "Durito Teja 20PZ", venta: 322877, pct: 4.6, color: "#F5A623" },
  { nombre: "Papa Casera 340g (3 SKUs)", venta: 273155, pct: 3.9, color: "#2563EB" },
...
const insights = [
  {
    ...
    detail: "61% de la venta. Presente en las 40 tiendas. Producto ancla que jala tráfico al anaquel.",
    color: "#E74C3C",
  },
  {
    title: "Tostadas 200g crecieron +472% YoY",
    detail: "Roja y Amarilla pasaron de $69K a $496K en Q1. Complemento ideal de la 70PZ.",
    color: "#F97316",
  },
  {
    title: "Papa Casera 45g: lanzada Ago 2025",
    detail: "3 sabores suman $411K (5.8%). Solo 8 meses en anaquel — categoría en construcción.",
    color: "#3B82F6",
  },
  {
    title: "Papa Casera 340g: nueva desde Dic 2025",
    detail: "3 sabores suman $273K (3.9%) en solo 4 meses. Crecimiento acelerado mes a mes.",
    color: "#2563EB",
  },
  {
    title: "Tostadas (3 SKUs) = 68% del sell-out",
    detail: "De $2.88M a $4.83M (+68% YoY). El core del portafolio sigue acelerando.",
    color: "#E74C3C",
  },
  {
    title: "Portafolio pasó de 21 a 44 SKUs",
    detail: "Más que duplicamos la oferta en 1 año. Diversificación sin perder foco en tostadas.",
    color: "#F5A623",
  },
];
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] text-gray-500">
              Participación por producto/grupo · Papas agrupadas por formato · Total: $7.09M
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex gap-4 flex-1 min-h-0">
        ...
        <div className="w-[420px] flex flex-col">
          <div className="flex-1 bg-white rounded-xl border border-gray-200 shadow-sm p-2 flex flex-col">
            ...
            {/* Legend below pie */}
            <div className="grid grid-cols-3 gap-x-3 gap-y-1 px-2 pb-1">
              {pieData.map((p, i) => (
