...
const barData = [
  { mes: "P01", v2025: 1011279, v2026: 1804665 },
  { mes: "P02", v2025: 1217578, v2026: 1927346 },
  { mes: "P03", v2025: 1557837, v2026: 2538388 },
];
...
export default function CrecAbaSlide1Portada() {
  return (
      ...
      <div className="flex items-center gap-3 mb-2">
        ...
        <div>
          <h2 className="text-xl font-bold text-gray-800">
            Crecimiento Abarrotes Q1 2026
          </h2>
          <p className="text-[10px] text-gray-500">
            Depto. Abarrotes DELIKOS en MERCO — Periodos 01-03 2026 vs 2025 — 20
            SKUs
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col min-h-0">
        <div className="flex items-center justify-between mb-1">
          <p className="text-[10px] text-gray-500 font-semibold uppercase">
            Venta por periodo Q1 — 2025 vs 2026 (Abarrotes)
          </p>
        ...
        <div className="flex-1 bg-white rounded-xl border border-gray-200 shadow-sm p-3 flex gap-4">
          ...
          <div className="w-[220px] flex flex-col justify-center gap-3">
            <div className="bg-emerald-50 rounded-lg p-3 border border-emerald-200">
              ...
              <p className="text-3xl font-bold text-emerald-700">+65.6%</p>
