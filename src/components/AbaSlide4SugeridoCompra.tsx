...
const dataTostadas: Sugerido[] = [
  { producto: "Tostada Amarilla 200g", tienda: "MERCO Montemorelos", tipo: "GRANDE", ddi: 0, invActual: 0, pallets: 0, cajas: 6, udsEnviar: 144 },
  ...
  { producto: "Tostada Roja 200g", tienda: "MERCO Nuevo Repueblo", tipo: "CHICA", ddi: 0, invActual: 0, pallets: 0, cajas: 5, udsEnviar: 120 },
  ...
  { producto: "Tostada Roja 200g", tienda: "MERCO Israel Cavazos", tipo: "GRANDE", ddi: 0, invActual: 0, pallets: 0, cajas: 6, udsEnviar: 144 },
  { producto: "Tostada Amarilla 200g", tienda: "MERCO Israel Cavazos", tipo: "GRANDE", ddi: 0, invActual: 0, pallets: 0, cajas: 6, udsEnviar: 144 },
  { producto: "Tostada Amarilla 200g", tienda: "MERCO Solidaridad", tipo: "GRANDE", ddi: 0, invActual: 151, pallets: 0, cajas: 6, udsEnviar: 144 },
  { producto: "Tostada Amarilla 200g", tienda: "MERCO Saltillo Centro", tipo: "GRANDE", ddi: 0, invActual: 0, pallets: 0, cajas: 6, udsEnviar: 144 },
  { producto: "Tostada Amarilla 200g", tienda: "MERCO Aramberri", tipo: "CHICA", ddi: 0, invActual: 0, pallets: 0, cajas: 5, udsEnviar: 120 },
  { producto: "Tostada Amarilla 200g", tienda: "MERCO Libramiento", tipo: "CHICA", ddi: 0, invActual: 0, pallets: 0, cajas: 5, udsEnviar: 120 },
];

const TOST_LINEAS = 77;
const TOST_UDS = 12432;

const dataPapas: Sugerido[] = [
  { producto: "Papa Fuego 45g", tienda: "MERCO Hidalgo", tipo: "GRANDE", ddi: 0, invActual: 0, pallets: 1, cajas: 0, udsEnviar: 420 },
  { producto: "Papa Jalapeño 45g", tienda: "MERCO Ramos Arizpe", tipo: "GRANDE", ddi: 0, invActual: 0, pallets: 1, cajas: 0, udsEnviar: 420 },
  { producto: "Papa Jalapeño 45g", tienda: "MERCO Castaños", tipo: "CHICA", ddi: 0, invActual: 0, pallets: 0, cajas: 1, udsEnviar: 45 },
  { producto: "Papa Jalapeño 45g", tienda: "MERCO Montemorelos", tipo: "GRANDE", ddi: 0, invActual: 0, pallets: 1, cajas: 0, udsEnviar: 420 },
  { producto: "Papa Jalapeño 45g", tienda: "MERCO Hidalgo", tipo: "GRANDE", ddi: 0, invActual: 0, pallets: 1, cajas: 0, udsEnviar: 420 },
  { producto: "Papa Natural 45g", tienda: "MERCO Hidalgo", tipo: "GRANDE", ddi: 0, invActual: 0, pallets: 1, cajas: 0, udsEnviar: 420 },
  { producto: "Papa Natural 45g", tienda: "MERCO San Buena", tipo: "CHICA", ddi: 0, invActual: 0, pallets: 0, cajas: 1, udsEnviar: 45 },
  { producto: "Papa Natural 45g", tienda: "MERCO Aramberri", tipo: "CHICA", ddi: 0, invActual: 77, pallets: 0, cajas: 1, udsEnviar: 45 },
  { producto: "Papa Jalapeño 45g", tienda: "MERCO Otilio", tipo: "GRANDE", ddi: 0, invActual: 141, pallets: 1, cajas: 0, udsEnviar: 420 },
  { producto: "Papa Natural 45g", tienda: "MERCO Ramos Arizpe", tipo: "GRANDE", ddi: 0, invActual: 0, pallets: 1, cajas: 0, udsEnviar: 420 },
];

const PAPAS_LINEAS = 45;
const PAPAS_UDS = 14535;
  ...
  return (
    <SlideWrapper className="bg-[#F5F5F5] p-8">
      ...
      <div className="mt-2 flex justify-between items-center">
        <p className="text-[10px] text-gray-400">Tostadas + Papa 45g · Inventario al 17-May-2026</p>
